# Project: Spire to USIC data compilation - SPNotShow Branch
# Create Date: 02/13/2020
# Last Updated: 010/09/2020
...
# Definition to sort email addresses
def getEmails(feature):
    ...
    """
    emails = ['brad.craddick@spireenergy.com','robert.domiano@spireenergy.com']
    for email in emails:
...
try:
    # Variable for html file location
    saveToFolder = r'C:\temp'

    # Empty var for feature
    feature="hi"
...
##    logPath = os.path.join(sdeTempPath, logName)
    log = open(r"C:\Scripts\USICLogs\USIC_Log.txt","a+")
    log.write("----------------------------" + "\n")
    log.write("----------------------------" + "\n")
...
#    # Open the log file
#    contents = open(r"C:\Scripts\USICLogs\USIC_Log.txt","a+")
#    # Write the log file to the html file
#    with open(r"C:\Scripts\USICLogs\USICScriptLog.html", "a+") as e:
